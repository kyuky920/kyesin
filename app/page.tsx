    ...
    <main className="bg-navy flex flex-col pb-nav max-w-[430px] mx-auto" style={{ minHeight: "100dvh" }}>
      ...
      <section className="flex-1 flex flex-col px-6 pt-7 pb-4">
        ...
        <div className="space-y-3 mt-auto">
          ...
          <Link
            href="/cell"
            className="flex items-center justify-center gap-2 w-full py-[14px] rounded-2xl text-[15px] font-medium active:scale-95 transition-transform"
            style={{ border: "1px solid rgba(233,185,74,0.3)", color: "#e9b94a" }}
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8}
