...
const MOCK_SCHEDULE: ScheduleItem[] = [
  ...
  // ── 7월 31일 (금) ─────────────────────────────────────────────
  { id: "m9",  retreat_id: "2026", day_date: "2026-07-31", start_time: "07:00", end_time: "08:00", title: "기상 및 개인 경건의 시간", item_type: "activity" },
  ...
  // ── 8월 1일 (토) ──────────────────────────────────────────────
  { id: "m22", retreat_id: "2026", day_date: "2026-08-01", start_time: "07:00", end_time: "08:00", title: "기상 및 개인 경건의 시간", item_type: "activity" },
...
const CAT: Record<string, CatStyle> = {
  worship: {
    border: "#a78bfa", bg: "rgba(139,92,246,0.28)", cardEdge: "rgba(167,139,250,0.40)",
    dot: "#c4b5fd", titleFg: "#f5f3ff",
    label: "예배", labelFg: "#ede9fe", labelBg: "rgba(139,92,246,0.50)",
  },
  lecture: {
    border: "#3b82f6", bg: "rgba(59,130,246,0.28)", cardEdge: "rgba(96,165,250,0.40)",
    dot: "#93c5fd", titleFg: "#eff6ff",
    label: "강의", labelFg: "#dbeafe", labelBg: "rgba(59,130,246,0.50)",
  },
  group: {
    border: "#10b981", bg: "rgba(16,185,129,0.26)", cardEdge: "rgba(52,211,153,0.40)",
    dot: "#6ee7b7", titleFg: "#ecfdf5",
    label: "조모임", labelFg: "#d1fae5", labelBg: "rgba(16,185,129,0.50)",
  },
  meal: {
    border: "#f59e0b", bg: "rgba(245,158,11,0.28)", cardEdge: "rgba(251,191,36,0.40)",
    dot: "#fde68a", titleFg: "#fffbeb",
    label: "식사", labelFg: "#fef3c7", labelBg: "rgba(245,158,11,0.50)",
  },
  activity: {
    border: "#06b6d4", bg: "rgba(6,182,212,0.26)", cardEdge: "rgba(34,211,238,0.40)",
    dot: "#67e8f9", titleFg: "#ecfeff",
    label: "활동", labelFg: "#cffafe", labelBg: "rgba(6,182,212,0.48)",
  },
  break: {
    border: "#94a3b8", bg: "rgba(100,116,139,0.30)", cardEdge: "rgba(148,163,184,0.35)",
    dot: "#cbd5e1", titleFg: "#f1f5f9",
    label: "휴식", labelFg: "#e2e8f0", labelBg: "rgba(100,116,139,0.45)",
  },
  arrival: {
    border: "#94a3b8", bg: "rgba(100,116,139,0.30)", cardEdge: "rgba(148,163,184,0.35)",
    dot: "#cbd5e1", titleFg: "#f1f5f9",
    label: "등록", labelFg: "#e2e8f0", labelBg: "rgba(100,116,139,0.45)",
  },
  departure: {
    border: "#94a3b8", bg: "rgba(100,116,139,0.30)", cardEdge: "rgba(148,163,184,0.35)",
    dot: "#cbd5e1", titleFg: "#f1f5f9",
    label: "귀가", labelFg: "#e2e8f0", labelBg: "rgba(100,116,139,0.45)",
  },
  notice: {
    border: "#f59e0b", bg: "rgba(233,185,74,0.28)", cardEdge: "rgba(233,185,74,0.40)",
    dot: "#fde68a", titleFg: "#fffbeb",
    label: "공지", labelFg: "#fef3c7", labelBg: "rgba(233,185,74,0.50)",
  },
  default: {
    border: "#64748b", bg: "rgba(71,85,105,0.30)", cardEdge: "rgba(100,116,139,0.35)",
    dot: "#94a3b8", titleFg: "#f1f5f9",
    label: "", labelFg: "#cbd5e1", labelBg: "rgba(71,85,105,0.40)",
  },
};
